                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">WEB APP</a>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">This is a profile-based project involves creating a detailed and comprehensive profile of a specific individual or entity. This could be for various purposes, such as professional networking, job applications, social media, or even personal branding.
	    </p>
	    <p><strong>Address:</strong>  Flat no: 602/009, ground Floor, Ahiran Kheda, Dubagga, Lucknow</p> 
	    <p><strong>Ph No: </strong>  +91-8896211006,7355252059</p>
		<p><strong>E-Mail ID :</strong>  mohdumair8896@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2024 <a href="#"  target="_blank" class="w3-hover-text-green"> Umair</a></p>
</footer>
