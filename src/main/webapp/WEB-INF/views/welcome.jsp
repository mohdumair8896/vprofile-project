                    ...
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#" style="margin-right:-8px; margin-top:-5px;">
                                <img alt="Brand" src="${contextPath}/resources/Images/user/user2.png" width="30px" height="30px">
                            </a>
                    ...
                    <div class="post-content">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <h4><a href="#" style="text-decoration:none;"><strong>Abrar Khan</strong></a> <small><small><a href="#" style="text-decoration:none; color:grey;"><i><i class="fa fa-clock-o" aria-hidden="true"></i> about 10 hours ago</i></a></small></small></h4>
                                <hr>
                                <div class="post-content">
                        ...
                        <div class="post-content">
                            <div class="panel-default">
                                <div class="panel-body">
                                    ...
                                    <h4><a href="#" style="text-decoration:none;"><strong>Shashank Mishra</strong></a></h4>
                                    <hr>
                                    <div class="post-content">
                        ...
                        <div class="post-content">
                            <div class="panel-default">
                                <div class="panel-body">
                                    ...
                                    <h4><a href="#" style="text-decoration:none;"><strong>Saif Ali</strong></a></h4>
                                    <hr>
                                    <div class="post-content">
